...
export default function SubjectLogBookPage() {
  return (
    <AppShell permission="logbook.view">
      <PageHeader icon="📓" title="Subject Log Book" subtitle="Track subject teaching logs" />

      <div className="rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-16 text-center">
        <div className="text-5xl">📓</div>
        <h2 className="mt-4 text-xl font-bold text-slate-800">Subject Log Book</h2>
        <p className="mt-2 max-w-md mx-auto text-sm text-slate-500">
          Track subject teaching logs. This module is coming soon — it will be built in the next update.
        </p>
