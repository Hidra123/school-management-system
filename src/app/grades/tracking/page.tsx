  ...
  return (
    <AppShell permission="grades.track">
      ...
      <div className="rounded-2xl border border-dashed border-slate-300 bg-white px-6 py-16 text-center">
        ...
        <h2 className="mt-4 text-xl font-bold text-slate-800">Score Tracking</h2>
        <p className="mt-2 mx-auto max-w-md text-sm text-slate-500">Score tracking and analytics coming soon.</p>
